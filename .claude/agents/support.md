...
3. **Feedback triage**: user feedback becomes a Backlog ticket via `gh issue create` with a body matching docs/rules/TICKET_TEMPLATE.md (docs/rules/WORKFLOW.md deferred-work rule). Frequency and severity in the Context section; never a TODO note.
