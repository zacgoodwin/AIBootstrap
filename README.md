...
| [zg-skills](docs/frameworks/ZG-SKILLS.MD) | zacgoodwin/zg-skills | This repo author's ship-and-review gate: the `/stack-ship` pipeline and the blinded review it cannot talk past |
...
context-engineering set, Anthropic's own plugins, roborev, ponytail, and
Claude Code's built-ins.
