...
|  Kanban   |  Local web app running CLI agents in parallel, one worktree per task card; hold-list (bypasses agent permissions and hooks)   |  https://github.com/cline/kanban  |
