...
All skills from [affaan-m/ECC](https://github.com/affaan-m/ECC), sorted under the same headings as the other files in docs/frameworks/. Upstream not pinned in tools/sources.json; `/skills-update` records the commit on its first full catalog pass.
